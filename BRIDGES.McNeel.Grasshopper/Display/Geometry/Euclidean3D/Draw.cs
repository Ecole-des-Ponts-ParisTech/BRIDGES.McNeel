...
namespace BRIDGES.McNeel.Grasshopper.Display.Geometry.Euclidean3D
{
    ...
    public static class Draw
    {
        ...
        public static void Plane(RH_Disp.DisplayPipeline display, Euc3D.Plane plane, bool isSelected)
        {
            ...
            Draw.Vector(display, plane.XAxis, isSelected);
            Draw.Vector(display, plane.YAxis, isSelected);
        }
        ...
        /// <summary>
        /// Draws a <see cref="He.HeMesh{TPosition}"/> in the <see cref="Rhino"/> viewports.
        /// </summary>
        /// <param name="display"> The Rhino helper for diplaying objects. </param>
        /// <param name="mesh"> <see cref="He.HeMesh{TPosition}"/> to display. </param>
        /// <param name="isSelected"> Evaluates whether the <see cref="He.HeMesh{TPosition}"/> is selected or not. </param>
        public static void Mesh(RH_Disp.DisplayPipeline display, He.HeMesh<Euc3D.Point> mesh, bool isSelected)
        {
        ...
        /// <summary>
        /// Draws a <see cref="Fv.FvMesh{TPosition}"/> in the <see cref="Rhino"/> viewports.
        /// </summary>
        /// <param name="display"> The Rhino helper for diplaying objects. </param>
        /// <param name="mesh"> <see cref="Fv.FvMesh{TPosition}"/> to display. </param>
        /// <param name="isSelected"> Evaluates whether the <see cref="Fv.FvMesh{TPosition}"/> is selected or not. </param>
        public static void Mesh(RH_Disp.DisplayPipeline display, Fv.FvMesh<Euc3D.Point> mesh, bool isSelected)
        {
