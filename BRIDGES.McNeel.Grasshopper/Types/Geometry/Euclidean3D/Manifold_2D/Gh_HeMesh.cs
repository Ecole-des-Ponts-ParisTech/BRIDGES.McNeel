...
{
    /// <summary>
    /// Class defining a grasshopper type for an <see cref="He.HeMesh{TPosition}"/>.
    /// </summary>
    public class Gh_HeMesh : GH_Types.GH_Goo<He.HeMesh<Euc3D.Point>>, GH_Kernel.IGH_PreviewData
    {
        #region Properties
        ...
        public RH_Geo.BoundingBox Boundingbox
        {
            get
            {
                ...
                foreach (He.HeVertex<Euc3D.Point> vertices in Value.GetVertices())
                {
        ...
        {
            this.Value = (He.HeMesh<Euc3D.Point>)gh_HeMesh.Value.Clone() ;
        }

        /// <summary>
        /// Initialises a new instance of <see cref="Gh_HeMesh"/> class from a <see cref="He.HeMesh{TPosition}"/>.
        /// </summary>
        /// <param name="heMesh"> <see cref="He.HeMesh{TPosition}"/> to duplicate.</param>
        public Gh_HeMesh(He.HeMesh<Euc3D.Point> heMesh)
        {
            this.Value = (He.HeMesh<Euc3D.Point>)heMesh.Clone();
        }
        ...
        public override string TypeDescription { get { return String.Format($"Grasshopper type containing a {typeof(He.HeMesh<Euc3D.Point>)}."); } }
        ...
        public override bool CastFrom(object source)
        {
            ...
            if (typeof(He.HeMesh<Euc3D.Point>).IsAssignableFrom(type))
            {
                Value = (He.HeMesh<Euc3D.Point>)source;
                return true;
            }
            ...
            if (typeof(RH_Geo.Mesh).IsAssignableFrom(type))
            {
                ...
                rh_Mesh.ConvertTo(out He.HeMesh<Euc3D.Point> mesh);
                Value = mesh;
        ...
        public override bool CastTo<T>(ref T target)
        {
            ...
            if (typeof(T).IsAssignableFrom(typeof(He.HeMesh<Euc3D.Point>)))
            {
